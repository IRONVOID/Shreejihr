...
export default function HiringProcess() {
  ...
  return (
    <section id="process" className="py-16 lg:py-24 bg-[#FAF6EE] border-b border-[#E5DAC4]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {HIRING_PROCESS.map((item, idx) => {
            ...
            return (
              <div
                key={item.step}
                className="bg-white rounded-lg p-5 border border-[#E5DAC4] flex flex-col justify-between shadow-xs"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] font-semibold text-slate-600 uppercase tracking-wider px-2 py-0.5 bg-[#FAF6EE] rounded border border-[#E5DAC4]">
                ...
                {idx === 5 && (
                  <div className="mt-4 pt-3 border-t border-[#E5DAC4]/60 flex items-center gap-1.5 text-xs font-bold text-emerald-700">
