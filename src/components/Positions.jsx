...
export default function Positions({ onSelectPosition }) {
  ...
  return (
    <section id="positions" className="py-16 lg:py-24 bg-[#F3EDE0] border-b border-[#E5DAC4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-4 rounded-xl border border-[#E5DAC4] shadow-xs mb-6 space-y-3">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2.5 bg-[#FAF6EE] border border-[#E5DAC4] rounded-lg text-sm text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#0B1F3F]"
              />
            </div>
          ...
          <div className="flex items-center gap-1.5 pt-2 border-t border-[#E5DAC4]/60 overflow-x-auto no-scrollbar py-1 -mx-1 px-1">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all shrink-0 whitespace-nowrap min-h-[34px] ${
                  selectedCategory === cat
                    ...
                    : 'bg-[#FAF6EE] text-slate-700 hover:bg-[#E5DAC4]'
                }`}
              >
                {cat}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {filteredPositions.map((pos) => {
            ...
            return (
              <div
                key={pos.name}
                className="bg-white rounded-lg p-4 border border-[#E5DAC4] hover:border-[#C9A227] transition-colors flex items-center justify-between gap-4 shadow-xs"
              >
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className="w-9 h-9 rounded bg-[#FAF6EE] border border-[#E5DAC4] text-[#0B1F3F] flex items-center justify-center flex-shrink-0">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs font-bold text-[#0B1F3F] hover:text-[#C9A227] flex-shrink-0 px-2.5 py-1 rounded bg-[#FAF6EE] border border-[#E5DAC4] hover:bg-[#E5DAC4] transition-colors"
                >
                  <span>Inquire</span>
        ...
        {filteredPositions.length === 0 && (
          <div className="text-center py-10 bg-white rounded-lg border border-[#E5DAC4]">
